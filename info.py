...
API_ID = int(environ.get('API_ID', '24104568')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '96d4cada419846dc011b019f412c23de')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "7012541014:AAGPG1mBUj9PQE1Na8g9H3AjcPFcqpK4nHk")    # Bot token from @BotFather
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5817124748').split()] # Replace with the actual admin ID(s) to add
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1001586987735'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001586987735'))  # Premium logs channel id
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Zenitsuaf:Zenitsuaf@cluster0.i58aapw.mongodb.net/?retryWrites=true&w=majority")  # MongoDB URI for the database
...
FQDN = environ.get("FQDN", "65.108.9.125")
